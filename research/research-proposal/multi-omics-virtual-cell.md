...
The goal is to create reliable simulations for single-cell and between-cells interactions: predict cellular responses with high accuracy, significantly reducing the cost and time of medical research.
...
- [Harnessing AI to Build Virtual Cells](https://www.biorxiv.org/content/10.64898/2026.04.11.717183v2) ([Video](https://www.youtube.com/watch?v=pwLfujLYwhA))
